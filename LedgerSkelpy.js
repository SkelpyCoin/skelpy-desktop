...
var LedgerSkelpy = function (comm) {
  this.comm = comm
  this.comm.setScrambleKey('w0w')
}

/* eslint-disable node/no-deprecated-api */
LedgerSkelpy.prototype.getAddress_async = function (path) {
...
LedgerSkelpy.prototype.signTransaction_async = function (path, rawTxHex) {
  var splitPath = utils.splitPath(path)
...
LedgerSkelpy.prototype.getAppConfiguration_async = function () {
...
LedgerSkelpy.prototype.signPersonalMessage_async = function (path, messageHex) {
  var splitPath = utils.splitPath(path)
  var offset = 0
