;(function () {
  ...
  angular
    ...
    .component('accountCard', {
      ...
      controller: ['$scope', '$mdDialog', '$mdBottomSheet', 'gettextCatalog', 'accountService', 'storageService', 'SKPTOSHI_UNIT', 'toastService', AccountCardController]
    })

  function AccountCardController ($scope, $mdDialog, $mdBottomSheet, gettextCatalog, accountService, storageService, SKPTOSHI_UNIT, toastService) {
    this.$onInit = () => {
    ...
    this.submitTransaction = (selectedAccount, formData) => {
      return accountService.createTransaction(0, {
        ...
        amount: parseInt((formData.amount * SKPTOSHI_UNIT).toFixed(0)),
    ...
    this.showSendTransaction = selectedAccount => {
      ...
      function totalBalance (minusFee) {
        ...
        return accountService.numberToFixed((minusFee ? balance - fee : balance) / SKPTOSHI_UNIT)
      }
