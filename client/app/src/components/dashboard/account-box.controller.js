;(function () {
  ...
  angular
    ...
    .component('accountBox', {
      ...
      controller: ['$scope', 'networkService', 'accountService', 'SKPTOSHI_UNIT', AccountBoxController]
    })

  function AccountBoxController ($scope, networkService, accountService, SKPTOSHI_UNIT) {
    this.$onInit = () => {
    ...
    this.myAccountsBalance = () => {
      ...
      return (total / SKPTOSHI_UNIT).toFixed(2)
    }
