...
var modules = [
  ...
  'monospaced.qrcode',
  'infinite-scroll',
  'skelpyclient.filters',
  'skelpyclient.services',
  'skelpyclient.components',
  'skelpyclient.directives',
  'skelpyclient.accounts',
  'skelpyclient.constants'
]

var app = angular.module('skelpyclient', modules)
